...
var index = algolia('F0YZGY7UD3', '97499d5966afe15ee445bf7499b98f4c')
    ...
    var sources = [
        {
            ...
            templates: {
                ...
                suggestion (suggestion) {
                    return '<span>' +
                        '<a href="/' + suggestion.area.slug + '/listings/' + suggestion.id + '">' + suggestion.title + '</a> ' +
                        'in ' + suggestion.category.name + '</span> ' +
    ...
    if(typeof categoryId !== 'undefined') {
        sources.unshift({
            ...
            templates: {
                ...
                return '<div class="aa-suggestions-category">This category</div>';
            },
                suggestion (suggestion) {
                    return '<span>' +
                        '<a href="/' + suggestion.area.slug + '/listings/' + suggestion.id + '">' + suggestion.title + '</a>' +
